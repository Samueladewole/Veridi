    ...
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-16 pt-[140px] pb-20 overflow-hidden">
      ...
      <div className="relative z-[2] max-w-[900px]">
        ...
        <motion.h1
          ...
          animate="visible"
          custom={0.3}
          className="font-serif text-[clamp(54px,7vw,96px)] font-normal leading-[1.02] tracking-[-0.025em] text-white mb-8"
        >
        ...
        <motion.p
          ...
          animate="visible"
          custom={0.5}
          className="font-mono text-[15px] font-light leading-[1.75] text-[var(--text2)] max-w-[560px] mb-[52px]"
        >
